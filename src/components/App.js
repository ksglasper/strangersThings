  ...
  return (
    <>
      ...
      <Header setCurrentUser={setCurrentUser}
          currentUser={currentUser} setUserToken={setUserToken} setAllPosts={setAllPosts} setMessagePostId={setMessagePostId}/>
        <Routes>
        
        <Route exact path={"/"} element={<Posts allPosts={allPosts} userToken={userToken} currentUser={currentUser} setUserPosts={setUserPosts} setAllPosts={setAllPosts} editPostId={editPostId} setEditPostID={setEditPostID} messagePostId={messagePostId} setMessagePostId={setMessagePostId}/>}></Route>
